...
QString addbookdialog::genre()  const { return m_genreEdit->text().trimmed(); }
int addbookdialog::year()   const { return m_yearEdit->text().toInt(); }
QString addbookdialog::status() const { return m_statusCombo->currentText(); }
